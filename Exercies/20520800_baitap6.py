    ...
    try:
        ...
        if train_button:
            with st.spinner("Waiting for training..."):
                ...
                model1 = LogisticRegression(n_jobs=4)
                ...
                if train_button:
                    ...
                    with st.spinner("Waiting for training..."):
                        ...
                        for train_idx, val_idx in k_fold.split(X_norm, y):
                            ...
                            precision_list.append(round(precision_score(y[val_idx], y_pred), 4))
                            recall_list.append(round(recall_score(y[val_idx], y_pred), 4))
                            f1_list.append(round(f1_score(y[val_idx], y_pred), 4))
